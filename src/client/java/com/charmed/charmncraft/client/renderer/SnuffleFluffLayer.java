...
public class SnuffleFluffLayer<T extends SnuffleEntity, M extends SnuffleModel<T>> extends FeatureRenderer<T, M> {
    ...
    public Identifier getTextureLocation(SnuffleEntity snuffle) {
