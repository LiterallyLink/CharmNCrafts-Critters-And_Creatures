...
public class RedPandaEntity extends AnimalEntity implements GeoEntity {
    private static final TrackedData<Boolean> SITTING = DataTracker.registerData(RedPandaEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new TemptGoal(this, 1.0, Ingredient.ofItems(Items.BAMBOO), false));
